...
void _testAlpha1() {
  test('Alpha1', () {
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.unexpected(0, 0, 'EOF')]);
    }
    {
      final state = State('$s32');
      final r = parser(state);
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.unexpected(0, 0, c32)]);
    }
  });
}
...
void _testAlt() {
  test('Alt', () {
    ...
    }
    {
      ...
      expect(
        state.errors,
        [ParseError.expected(0, c16), ParseError.expected(0, c32)],
      );
    }
    {
      final state = State(' $s16');
      ...
      expect(state.pos, 0);
      expect(state.errors, [
        ParseError.expected(0, c16),
        ParseError.expected(0, c32),
      ]);
    }
  });
}
...
void _testAnd() {
  test('And', () {
    ...
    }
    {
      ...
      expect(state.ok, false);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.message(state.pos, 0, 'Unknown error')]);
    }
    {
      final state = State(' ');
      parser(state);
...
void _testBinaryExpression() {
  test('BinaryExpression', () {
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.unexpected(4, 0, 0x61)]);
    }
    {
      final state = State('1+2-');
      final r = parser(state);
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.unexpected(4, 0, 'EOF')]);
    }
  });
}
  ...
  test('Char', () {
    for (var i = 0; i < 2; i++) {
      ...
      }
      {
        ...
        expect(r, null);
        expect(state.pos, 0);
        expect(state.errors, [ParseError.expected(0, c)]);
      }
      {
        final state = State('');
        final r = parser(state);
...
void _testDelimited() {
  test('Delimited', () {
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.expected(1, c32)]);
    }
  });
}
...
void _testEof() {
  test('Eof', () {
    ...
    }
    {
      ...
      expect(state.ok, false);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.expected(0, 'EOF')]);
    }
  });
}
...
void _testEscapeSequence() {
  test('EscapeSequence', () {
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.unexpected(0, 0, 0x20)]);
    }
    {
      final state = State('$s32');
      final r = parser16(state);
...
void _testManyMN() {
  test('ManyMN', () {
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.expected(2, c32)]);
    }
    {
...
void _testMap() {
  test('Map4', () {
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.unexpected(3, 0, c16)]);
    }
    {
      final state = State('123');
      final r = parser(state);
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.unexpected(3, 0, 'EOF')]);
    }
    {
      final state = State(' ');
      final r = parser(state);
...
void _testNested() {
  test('Nested', () {
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.unexpected(2, 0, 'EOF')]);
    }
    {
      final state = State('');
      final r = parser(state);
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.expected(0, 'nested')]);
    }
    {
      final state = State(' ');
      final r = parser(state);
...
void _testNoneOf() {
  test('NoneOf', () {
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.unexpected(0, 0, c16)]);
    }
    {
      final state = State('');
      final r = parser16(state);
...
void _testNoneOfTags() {
  test('NoneOfTags', () {
    ...
    }
    {
      ...
      expect(state.ok, false);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.unexpected(0, 0, 'x')]);
    }
    {
...
void _testOneOf() {
  test('OneOf', () {
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.unexpected(0, 0, 0x61)]);
    }
    {
      final state = State('');
      final r = parser16(state);
...
void _testRecognize() {
  test('Recognize', () {
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.expected(2, abc)]);
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.expected(5, c16)]);
    }
  });
}
  ...
  for (final key in parsers.keys) {
    ...
    test('Semantic action VariableAction', () {
      ...
      }
      {
        ...
        expect(r, null);
        expect(state.pos, 0);
        expect(state.errors, [ParseError.unexpected(0, 0, 0x31)]);
      }
    });
  }
}
...
void _testSeparatedListN() {
  test('SeparatedListN', () {
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.expected(5, c32)]);
    }
    {
      final state = State('$s32$abc$s32');
      final r = parser(state);
...
void _testSeparatedPair() {
  test('SeparatedPair', () {
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.expected(4, c32)]);
    }
    {
      final state = State('');
      final r = parser(state);
...
void _testTag() {
  test('Tag', () {
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.expected(0, s16)]);
    }
    {
      final state = State(' ');
      final r = parser16(state);
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.expected(0, s16 + s32)]);
    }
    {
      final state = State(' ');
      final r = parserC16C32(state);
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.expected(0, s32)]);
    }
    {
      final state = State(' ');
      final r = parser32(state);
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.expected(0, s32 + s16)]);
    }
    {
      final state = State(' ');
      final r = parserC32C16(state);
...
void _testTagOf() {
  test('TagOf', () {
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.expected(0, foo)]);
    }
    {
      final state = State(' $foo');
      state.context = _StateContext();
...
void _testTags() {
  test('Tags', () {
    ...
    }
    {
      ...
      expect(state.errors, [
        ParseError.expected(0, 'abc'),
        ParseError.expected(0, 'abd'),
        ParseError.expected(0, 'def'),
        ParseError.expected(0, 'deg'),
        ParseError.expected(0, 'x'),
        ParseError.expected(0, 'xy'),
      ]);
    }
    {
      final state = State('abx');
  ...
  test('TakeWhileMN', () {
    for (var i = 0; i < 2; i++) {
      ...
      }
      {
        ...
        expect(r, null);
        expect(state.pos, 0);
        expect(state.errors, [ParseError.unexpected(1 * len, 0, 'EOF')]);
      }
      {
        final sBad = '0';
        ...
        expect(r, null);
        expect(state.pos, 0);
        expect(state.errors, [ParseError.unexpected(1 * len, 0, cBad)]);
      }
      {
        final sBad = '0';
        final cBad = sBad.codeUnitAt(0);
        ...
        expect(r, null);
        expect(state.pos, 0);
        expect(state.errors, [ParseError.unexpected(0, 0, cBad)]);
      }
    }
  });
}
...
void _testVerify() {
  test('Verify', () {
    ...
    }
    {
      ...
      expect(r, null);
      expect(state.pos, 0);
      expect(state.errors, [ParseError.message(0, 0, 'Message')]);
    }
    {
      final state = State('12');
      final r = parser(state);
